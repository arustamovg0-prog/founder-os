...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-secondary)] py-24 px-6 sm:px-12">
      <div className="max-w-3xl mx-auto bg-[var(--bg-card)] border border-[var(--border)] p-8 md:p-12 rounded-2xl shadow-xl">
        ...
        <div className="space-y-8 text-neutral-400">
          ...
          <section>
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">3. Data Security and GDPR Compliance</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">4. Contact Us</h2>
            <p className="leading-relaxed">
        ...
        <div className="mt-12 pt-8 border-t border-[#333]">
          <Link href="/" className="text-[#00F0FF] hover:text-[var(--text-primary)] transition-colors duration-200 font-medium">
            &larr; Back to Home
          </Link>
        </div>
      </div>
